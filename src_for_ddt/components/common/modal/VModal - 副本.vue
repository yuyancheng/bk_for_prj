<template id="main" xmlns:v-on="http://www.w3.org/1999/xhtml" xmlns:v-bind="http://www.w3.org/1999/xhtml">
    <div>
        ...
        <div class="v-modal-toast">
            <div v-show="isLoading" class="all-shade" :class="{'fade-out': fadeOut}">
                <div class="all-loading"><img src="../../../assets/image/loading.gif"></div>
            </div>
            <div v-show="isLoaded" class="all-loading" :class="{'fade-out': fadeOut}">
            ...
            <div v-show="isFailed" class="all-loading" :class="{'fade-out': fadeOut}">
