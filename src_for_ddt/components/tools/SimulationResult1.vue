...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted () {
            ...
            window.echarts.registerMap('china', this.mapGeo);
            this.initMap();
        ...
        methods: {
            ...
            resetData (dt) {
                ...
                this.spark(this.resultList[this.defaultIdx]);
            },
            remove () {
                this.isHoverA = false;
                this.isHoverB = false;
            ...
            drawTargetArea (name) {
                ...
                for (let i = 0, len = whDestData.length; i < len; i++) {
                    ...
                    if (name === whDestData[i]['startCode'] && idx === -1) {
                        province.push({
                    ...
                    if (idx !== -1) {
                        province[idx] += whDestData[i]['numPack'];
                    }
                }
            ...
            spark (data) {
                ...
                let setMapData = (dt) => {
                    ...
                    if (that.fixedIdx === 10000 || that.showSpark) {
                        whDestData = dt;
                        mapChart.clear();
                        mapChart.setOption(this.setOptions(convertData(sparkDt)));
                    }
                };
                ...
                this.ajaxSettings.success = (res) => {
                    ...
                    if (data && data.length > 0) {
                        ...
                        mapChart.clear();
                        mapChart.setOption(this.setOptions(convertData([])));
            ...
            setOptions (dtA, dtB) {
                if (dtA) {
                    mapOption.series[0].data = dtA;
                }
                if (dtB) {
                    mapOption.series[1].data = dtB;
                }
